          ...
          Expanded(
            child: BlocConsumer<OrderCubit, OrderState>(
              ...
              builder: (context, state) {
                if (state is OrdersFetchingSuccess) {
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (_selectedFilter != 'All') {
                        if (_selectedFilter == 'Ongoing Orders' &&
                            !['Pending', 'Confirmed', 'In Progress']
                                .contains(order.status)) {
                          return const SizedBox.shrink();
                        } else if (_selectedFilter != 'Ongoing Orders' &&
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  _buildDetailRow(
                    Icons.access_time,
                    '${DateFormat('MMM dd, yyyy').format(orderDate)} • ${order.deliveryDate}',
                  ),
