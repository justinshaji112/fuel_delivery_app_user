...
import 'package:fuel_delivery_app_user/core/auth/data/models/auth_model.dart';
import 'package:fuel_delivery_app_user/core/auth/domain/usecases/check_sign_in_usecase.dart';
import 'package:fuel_delivery_app_user/core/auth/domain/usecases/sign_out_usecase.dart';
import 'package:fuel_delivery_app_user/core/auth/domain/usecases/signin_usecase.dart';
import 'package:fuel_delivery_app_user/core/auth/domain/usecases/signin_with_google_usecase.dart';
import 'package:fuel_delivery_app_user/core/auth/domain/usecases/saveuser_data_usecase.dart';
import 'package:fuel_delivery_app_user/core/auth/domain/usecases/send_verification_email.dart';
import 'package:fuel_delivery_app_user/core/auth/domain/usecases/sign_up_usecase.dart';
import '../../../domain/usecases/check_email_veryfied_usecase.dart';
import '../../../../../config/errors/faliure.dart';
...
class AuthBloc extends Bloc<AuthEvent, AuthState> {
  ...
  AuthBloc(
    ...
    on<SignUpButtonPressedEvent>((event, emit) => singUP(
...
singUP(
    ...
    required SignUpButtonPressedEvent event,
